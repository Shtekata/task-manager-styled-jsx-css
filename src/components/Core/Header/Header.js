      ...
      <nav className='navigation'>
        <div className='header-div'>
          <div className="header header-side header-div header-left">
            <Link to='/'><div className='header-item-img'><img src="/bird.png" alt="bird" /></div></Link>
          ...
          <div className="header header-side header-div header-right">
            ...
            <div className="image">
              {state.user ? state.photoUrl ?
                <Link to={`/auth/profile/${state.userId}`}><img src={state.photoUrl} className='profile-picture' alt="no picture" /></Link>
                : <Link to={`/auth/profile/${state.userId}`}><img src={profilePicture} className='profile-picture' alt="no picture" /></Link>
                : ''
              }
            </div>
          </div>
